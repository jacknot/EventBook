 ...
 * Il valore che contiene pu� essere di diversi tipi, per ogni campo questo deve essere specificato.<br>
 * @param <T> Il tipo di valore che un campo pu� contenere.
...
public class Field <T>{
	...
	/**Restituisce il tipo con il quale il campo � stato parametrizzato
	 * @return il tipo di dati che il campo pu� contenere
	 */
	public Class<T> getType(){
		return type;
	}
	/**Restituisce se il campo � obbligatorio
	 ...
	 * Se il tipo del valore non � appropriato il vecchio valore non viene aggiornato
	...
	/**Controlla se non � stato assegnato un valore al campo
	 * @return True - non � ancora stato dato un valore al campo<br>False - � gi� stato dato un valore al campo
	 */
